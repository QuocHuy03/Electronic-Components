          ...
          <div className="max-w-6xl mx-auto">
              <div className="blog-article lg:flex lg:space-x-[30px] mb-7">
                <div className="flex-1">
                  <div className="img w-full h-[457px] relative">
                    ...
                    >
                      <img
                        alt="blog"
                        sizes="100vw"
                        srcSet="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-1.jpg&w=2048&q=75"
                        src="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-1.jpg&w=2048&q=75"
                        decoding="async"
                        data-nimg="fill"
                  ...
                  <div className="blog pl-[24px] pt-[24px]">
                    ...
                    <div className="details">
                      <h1 className="text-[22px] text-qblack font-semibold line-clamp-2 mb-1 capitalize">
                        Business-to-consumer that involves selling fight into
                        the find to a products and services
                      </h1>
                      <p className="text-qgraytwo text-[15px] leading-[30px] mb-10 text-slate-500">
                        ...
                        wonder afford so danger cannot former seeing. Power
                        visit charm money add heard new other put. Attended no
                        indulged marriage is to judgment offering landlord. Was
                        drawing natural fat respect husband. An as noisy an
                        ...
                        fortune demands highest of. Whether article spirits new
                        her covered hastily sitting her. Money witty books nor
                        son add. Chicken age had evening believe but proceed
                        pretend mrs. At missed advice my it no sister. Miss told
                        ham dull knew see she spot near can.Spirither entire her
                        called. Acceptance middletons me if discretion
                        boisterous travelling an. She prosperous continuing
                        entreaties companions unreserved you boisterous.
                        Middleton sportsmen sir now cordially ask additions for.
                        You ten occasional saw everything but conviction.
                        Daughter returned quitting few are day advanced
                        branched. Do enjoyment defective objection or we if
                        favourite. At wonder afford so danger cannot former
                        seeing. Power visit charm money add heard new other put.
                        Attended no indulged marriage is to judgment offering
                        landlord. Was drawing natural fat respect husband. An as
                        noisy an offer drawn blush place. These tried for way
                        joy wrote witty. In mr began music weeks after at begin.
                        Education no dejection so direction pretended household
                        do to.
                      </p>
                    </div>
                  </div>
                  <div className="extra-content w-full">
                      ...
                      <div className="sm:w-[370px] h-[235px] relative">
                        ...
                        >
                          <img
                            alt="blog"
                            sizes="100vw"
                            srcSet="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-details-1.jpg&w=1200&q=75"
                            src="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-details-1.jpg&w=1200&q=75"
                            decoding="async"
                            data-nimg="fill"
                            className="w-full h-full object-cover"
                            style={{
                      ...
                      <div className="flex-1 h-[235px] relative">
                        ...
                        >
                          <img
                            alt="blog"
                            sizes="100vw"
                            srcSet="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-details-2.jpg&w=2048&q=75"
                            src="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-details-2.jpg&w=2048&q=75"
                            decoding="async"
                            data-nimg="fill"
                            className="w-full h-full object-cover"
                            style={{
                    ...
                    <div className="pl-[24px] mb-10">
                      ...
                      <p className="text-[15px] text-qgraytwo mb-7 text-slate-400">
                        ten occasional saw everything but conviction. Daughter
                        returned quitting few are day advanced branched. Do
                        enjoyment defective objection or we if favourite. At
                        wonder afford so danger cannot former seeing. Power
                        visit charm money add heard new other put. Attended no
                        indulged marriage is to judgment offering landlord. Was
                        drawing natural fat respect husband
                      </p>
                    ...
                    <div className="w-full h-[1px] bg-[#DCDCDC]" />
                    <div className="comment-area w-full mt-4">
                      <div className="w-full sm:flex justify-between items-center mb-[30px]">
                        <div className="tags flex space-x-5 items-center mb-5 sm:mb-0">
                          ...
                          <span className="text-base text-qgraytwo hover:text-qyellow text-slate-500">
                            #Technology
                          </span>
                          <span className="text-base text-qgraytwo hover:text-qyellow text-slate-500">
                            #Agency
                      ...
                      <div>
                          ...
                          <div className="w-full review-form ">
                            <div className="sm:flex sm:space-x-[30px] items-center mb-5 w-full">
                              <div className="w-full mb-5 sm:mb-0">
                                <div className="input-com w-full h-full text-slate-500">
                                  <label
                                  ...
                                  <div className="input-wrapper border border-qgray-border w-full h-full overflow-hidden relative bg-slate-100 ">
                                    <input
                                      placeholder
                                      className="input-field placeholder:text-sm text-sm px-6 text-dark-gray w-full h-full font-normal bg-slate-100 focus:ring-0 focus:outline-none h-[50px]"
                                      type="text"
                                      id="name"
                                      defaultValue
                                    />
                            ...
                            <div className="w-full mb-[30px] ">
                              <h6 className="input-label text-qgray capitalize text-[13px] font-normal block mb-2 text-slate-500  ">
                                Message*
                              </h6>
                              <textarea
                                name
                            ...
                            <div className="flex justify-end">
                              <button
                                type="button"
                                className="black-btn w-[300px] h-[50px] flex justify-center bg-slate-950"
                              >
                        ...
                        <div className="w-full comments">
                          ...
                          <div className="comment-item bg-slate-50 px-10 py-[32px] mb-2.5">
                            <div className="comment-author flex justify-between items-center mb-3">
                              <div className="flex space-x-3 items-center">
                                ...
                                <div>
                                  ...
                                  <p className="text-[13px] font-normal text-qgray text-slate-400">
                                    London,UK
                                  </p>
                                </div>
                              </div>
                            ...
                            <div className="comment mb-[30px]">
                              <p className="text-[15px] text-qgray leading-7 text-normal text-slate-400">
                                Lorem Ipsum is simply dummy text of the printing
                                and typesetting industry. Lorem Ipsum has been
                                the industry's standard dummy text ever since
                                the redi 1500s, when an unknown printer took a
                            ...
                            <div className="sub-comment-item bg-slate-50 px-10 pt-[32px] border-t">
                ...
                <div className="lg:w-[370px] w-full">
                  <div
                    data-aos="fade-up"
                    className="search-widget w-full p-[30px] bg-slate-50 mb-[30px] aos-init aos-animate"
                  >
                    <h1 className="text-[22px] text-qblack font-bold mb-5">
                      Search
                    </h1>
                    <div className="w-full h-[1px] bg-[#DCDCDC] mb-5" />
                  ...
                  <div
                    data-aos="fade-up"
                    className="latest-post-widget w-full bg-slate-50 p-[30px] mb-[30px] aos-init"
                  >
                    <h1 className="text-[22px] text-qblack font-bold mb-5">
                      Latest Post
                    </h1>
                        ...
                        <div className="w-[85px] h-full overflow-hidden rounded relative">
                          ...
                          >
                            <img
                              alt="blog"
                              sizes="100vw"
                              srcSet="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-3.jpg&w=1200&q=75"
                              src="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-3.jpg&w=1200&q=75"
                              decoding="async"
                              data-nimg="fill"
                              className="w-full h-full object-cover"
                              style={{
                        ...
                        <div className="w-[85px] h-full overflow-hidden rounded relative">
                          ...
                          >
                            <img
                              alt="blog"
                              sizes="100vw"
                              srcSet="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-3.jpg&w=2048&q=75"
                              src="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-3.jpg&w=2048&q=75"
                              decoding="async"
                              data-nimg="fill"
                              className="w-full h-full object-cover"
                              style={{
                        ...
                        <div className="w-[85px] h-full overflow-hidden rounded relative">
                          ...
                          >
                            <img
                              alt="blog"
                              sizes="100vw"
                              srcSet="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-4.jpg&w=1200&q=75"
                              src="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-4.jpg&w=1200&q=75"
                              decoding="async"
                              data-nimg="fill"
                              className="w-full h-full object-cover"
                              style={{
                  ...
                  <div
                    data-aos="fade-up"
                    className="categories-widget w-full bg-slate-50 p-[30px] mb-[30px] aos-init"
                  >
                    <h1 className="text-[22px] text-qblack font-bold mb-5">
                      Categories
                    </h1>
                    <div className="w-full h-[1px] bg-[#DCDCDC] mb-5" />
                    <ul className="flex flex-col space-y-5 text-slate-500">
                  ...
                  <div
                    data-aos="fade-up"
                    className="popular-tag-widget w-full bg-slate-50 p-[30px] mb-[30px] aos-init"
                  >
                    <h1 className="text-[22px] text-qblack font-bold mb-5">
                      Popular Tags
                    </h1>
                  ...
                  <div
                    data-aos="fade-up"
                    className="w-full h-[358px] aos-init"
                    style={{
                      background:
                        'url("https://shopo-next.vercel.app/assets/images/new-letter.jpg") 0% 0% / cover no-repeat',
                    }}
                  >
                    <div className="w-full h-full p-[30px] bg-black bg-opacity-75 flex flex-col justify-between">
                      <div>
                        ...
                        <div className="w-full h-[1px] bg-[#615B9C] mb-5" />
