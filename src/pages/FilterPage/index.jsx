            ...
            <div className="w-full lg:flex lg:space-x-[30px]">
              ...
              <div className="flex-1">
                    ...
                    >
                      ...
                      <div className="product-card-details px-[30px] pb-[30px] relative">
                        <div className="absolute w-full h-10 px-[30px] left-0 top-40 group-hover:top-[85px] transition-all duration-300 ease-in-out">
                          <button type="button" className="bg-yellow-400 items-center flex h-full w-full  opacity-1 justify-center">
                ...
                <div className="w-full h-[164px] overflow-hidden mb-[40px]">
                  <img
                    src="https://shopo-next.vercel.app/assets/images/ads-6.png"
                    alt
                    className="w-full h-full object-contain"
                  />
                </div>
                      ...
                      >
                        <div className="px-[30px] absolute left-0 top-3 w-full">
                          ...
                          <div className="progress w-full h-[5px] rounded-[22px] bg-primarygray relative overflow-hidden">
                            <div
                              className="h-full absolute left-0 top-0  bg-amber-400"
                              style={{ width: "65.5172%" }}
                            />
                          </div>
                        </div>
