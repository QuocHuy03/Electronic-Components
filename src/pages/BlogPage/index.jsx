            ...
            <div className="max-w-6xl mx-auto">
              <div className="w-full">
                <div className="grid md:grid-cols-2 grid-cols-1 lg:gap-[30px] gap-5">
                      ...
                      <div className="p-[24px]">
                        ...
                        <div className="details">
                          ...
                          <p className="text-qgraytwo text-[15px] leading-[30px] line-clamp-2 mb-3">
                            ...
                            nulla tempor nostrud eiusmod commodo mollit magna
                            sint laboris excepteur elit cupidatat id
                          </p>
                          <a href="#">
                    ...
                    <div className="blog-card-wrapper w-full border border-[#D3D3D3] ">
                      <div className="img w-full h-[340px] relative">
                        ...
                        >
                          <img
                            alt="blog"
                            sizes="100vw"
                            srcSet="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-6.jpg&w=828&q=75"
                            src="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-6.jpg&w=828&q=75"
                            decoding="async"
                            data-nimg="fill"
                            className="w-full h-full object-cover"
                            style={{
                      ...
                      <div className="p-[24px]">
                        ...
                        <div className="details">
                          ...
                          <p className="text-qgraytwo text-[15px] leading-[30px] line-clamp-2 mb-3">
                            adipisicing dolor esse voluptate occaecat laborum
                            fugiat adipisicing laboris id cupidatat deserunt
                            exercitation et velit consectetur eiusmod pariatur
                            ullamco enim ut nulla qui minim sunt minim amet non
                            culpa aliqua
                          </p>
                          <a href="#">
                            <div className="flex items-center space-x-2">
                  ...
                  <div data-aos="fade-up" className="item w-full aos-init">
                    <div className="blog-card-wrapper w-full border border-[#D3D3D3] ">
                      <div className="img w-full h-[340px] relative">
                        <span
                          style={{
                        ...
                        >
                          <img
                            alt="blog"
                            sizes="100vw"
                            srcSet="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-3.jpg&w=828&q=75"
                            src="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-3.jpg&w=828&q=75"
                            decoding="async"
                            data-nimg="fill"
                            className="w-full h-full object-cover"
                            style={{
                      ...
                      <div className="p-[24px]">
                        ...
                        <div className="details">
                          <h1 className="text-[22px] text-qblack hover:text-blue-500 font-semibold line-clamp-2 mb-1 capitalize">
                            consequat qui non irure mollit laboris id
                          </h1>
                          <p className="text-qgraytwo text-[15px] leading-[30px] line-clamp-2 mb-3">
                            incididunt nisi minim elit occaecat nostrud do non
                            commodo commodo magna est et ex consequat amet
                            fugiat aute magna reprehenderit consequat ut quis
                            qui reprehenderit officia nostrud ex amet excepteur
                          </p>
                          <a href="#">
                            <div className="flex items-center space-x-2">
                              <span className="text-qblack text-base font-semibold">
                  ...
                  <div data-aos="fade-up" className="item w-full aos-init">
                    <div className="blog-card-wrapper w-full border border-[#D3D3D3] ">
                      <div className="img w-full h-[340px] relative">
                        ...
                        >
                          <img
                            alt="blog"
                            sizes="100vw"
                            srcSet="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-4.jpg&w=828&q=75"
                            src="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-4.jpg&w=828&q=75"
                            decoding="async"
                            data-nimg="fill"
                            className="w-full h-full object-cover"
                            style={{
                      ...
                      <div className="p-[24px]">
                        ...
                        <div className="details">
                          <h1 className="text-[22px] text-qblack hover:text-blue-500 font-semibold line-clamp-2 mb-1 capitalize">
                            esse est in mollit nostrud adipisicing duis
                          </h1>
                          <p className="text-qgraytwo text-[15px] leading-[30px] line-clamp-2 mb-3">
                            veniam mollit cillum aliquip quis proident cupidatat
                            aute do cupidatat magna non ea laborum pariatur
                            dolor sit anim et duis duis ut cupidatat cillum
                            consectetur pariatur tempor eiusmod ea eiusmod
                          </p>
                          <a href="#">
                            <div className="flex items-center space-x-2">
                              <span className="text-qblack text-base font-semibold">
                  ...
                  <div data-aos="fade-up" className="item w-full aos-init">
                    <div className="blog-card-wrapper w-full border border-[#D3D3D3] ">
                      <div className="img w-full h-[340px] relative">
                        ...
                        >
                          <img
                            alt="blog"
                            sizes="100vw"
                            srcSet="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-1.jpg&w=828&q=75"
                            src="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-1.jpg&w=828&q=75"
                            decoding="async"
                            data-nimg="fill"
                            className="w-full h-full object-cover"
                            style={{
                      ...
                      <div className="p-[24px]">
                        ...
                        <div className="details">
                          <h1 className="text-[22px] text-qblack hover:text-blue-500 font-semibold line-clamp-2 mb-1 capitalize">
                            eiusmod elit deserunt eiusmod ea velit quis
                          </h1>
                          <p className="text-qgraytwo text-[15px] leading-[30px] line-clamp-2 mb-3">
                            nisi anim culpa nisi ullamco est laborum
                            reprehenderit proident ex anim quis adipisicing
                            tempor officia nulla deserunt ex duis consequat
                            laboris esse mollit ea excepteur ullamco deserunt
                  ...
                  <div data-aos="fade-up" className="item w-full aos-init">
                    <div className="blog-card-wrapper w-full border border-[#D3D3D3] ">
                      <div className="img w-full h-[340px] relative">
                        ...
                        >
                          <img
                            alt="blog"
                            sizes="100vw"
                            srcSet="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-2.jpg&w=828&q=75"
                            src="https://shopo-next.vercel.app/_next/image?url=%2Fassets%2Fimages%2Fblog-img-2.jpg&w=828&q=75"
                            decoding="async"
                            data-nimg="fill"
                            className="w-full h-full object-cover"
                            style={{
                      ...
                      <div className="p-[24px]">
                        ...
                        <div className="details">
                          <h1 className="text-[22px] text-qblack hover:text-blue-500 font-semibold line-clamp-2 mb-1 capitalize">
                            Lorem culpa qui proident est mollit officia
                          </h1>
                          <p className="text-qgraytwo text-[15px] leading-[30px] line-clamp-2 mb-3">
                            ut sit velit esse laborum ad dolor voluptate nostrud
                            dolore labore ipsum voluptate labore mollit
                            exercitation veniam pariatur ipsum eiusmod irure
                            Lorem ad culpa commodo deserunt laborum eu voluptate
                            sint
                          </p>
                          <a href="#">
                            <div className="flex items-center space-x-2">
