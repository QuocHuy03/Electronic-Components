                  ...
                  <div data-aos="fade-up" className="item aos-init">
                    ...
                    >
                      <div
                        ...
                        style={{
                          background:
                            'url("https://shopo-next.vercel.app/assets/images/product-img-4.jpg") center center no-repeat',
                        }}
                      >
                        <div className="px-[30px] absolute left-0 top-3 w-full">
                          <div className="progress-title flex justify-between ">
                  ...
                  <div data-aos="fade-up" className="item aos-init">
                    ...
                    >
                      <div
                        ...
                        style={{
                          background:
                            'url("https://shopo-next.vercel.app/assets/images/product-img-5.jpg") center center no-repeat',
                        }}
                      >
                        <div className="px-[30px] absolute left-0 top-3 w-full">
                          <div className="progress-title flex justify-between ">
