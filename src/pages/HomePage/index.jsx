          ...
          <div className="relative max-w-6xl mx-auto rounded-md min-h-[416px]">
            ...
            >
              ...
              >
                <div
                  type="title"
                  className=" border-gray-300 bg-opacity-70 text-white font-[500] text-lg leading-7 overflow-hidden whitespace-normal transition duration-300 ease-in-out delay-0s"
                >
                  LAPTOP
                </div>
              </Link>
              <Link to={URL_CONSTANTS.FILTER}>
                <div className="flex space-x-2 items-center">
                  <p className="text-base font-[500] text-white">Xem thêm</p>
